#!/bin/bash -x
gcc tc_ins.c -o tc_ins -g -I/root/Programs/libforward-tc/include -L/root/Programs/libforward-tc -Wl,-rpath=/root/Programs/libforward-tc -lforward-tc -lmnl -lrt -DTCSW 
